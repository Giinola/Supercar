...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['supprimer'])) {
  ...
  $bdd->query("DELETE FROM range_rover WHERE id = $voitureId");
...
$voitures = [];
$resultats = $bdd->query("SELECT * FROM range_rover ORDER BY id ASC");
...
<body>
  <h1>Administration - Range Rover</h1>
