...
$contenu = [];
$resultats = mysqli_query($bdd, "SELECT * FROM mclaren");
...
<body>
  ...
  <section class="brand ford">
    ...
    <div class="marque-info">
      ...
      <h1>Mc Laren</h1>
      <p>McLaren est synonyme d'ingénierie de Formule 1 appliquée à la route. Marque britannique d'élite, elle se spécialise dans les supercars et hypercars ultra-légères, connues pour leur châssis en fibre de carbone, leur pureté de conduite et leur performance chirurgicale sur circuit</p>
